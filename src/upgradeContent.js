...
export const EVOLUTION_LIST = [
    ...
    { id: 'dubia_defenders', weaponKey: 'dubiashields', weaponLabel: 'Dubia Shields',   boostName: 'Bug Bucket',         evolvedName: 'Dubia Defenders', desc: 'Faster spinning dubias that fire projectiles; every fifteen enemies defeated by this will make a temporary extra shield. If an enemy is hit five times by the rotating dubias, it will trigger an explosion.' },
